...
from service.authorizer.monitor.car.scoring_car_monitor import ScoringCarMonitor
...
registration_id_format = AnyRegistrationIdFormat()
car_monitor = ScoringCarMonitor(license_plate_monitor, car_registry, registration_id_format)
